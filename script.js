...
Define a function called calculateGrade. It should take a numerical score and return the corresponding letter grade (A, B, C, D, F). 
...
console.log('Exercise 12 Result:', calculateGrade(89));
...
const createUsername = (firstName,lastName) => {
    ...
    const nameLetters = firstName.substr(0,3);
    const lastNameLetters = lastName.substr(0,3);
    const numberOfLetters = (firstName.length)+(lastName.length)
    const username = nameLetters+lastNameLetters+numberOfLetters
    return username
}
